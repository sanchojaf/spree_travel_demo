...
#gem 'spree_travel_flight',       :git => "#{SPREE_TRAVEL_PATH}/spree_travel_destination"
#gem 'spree_travel_point',        :git => "#{SPREE_TRAVEL_PATH}/spree_travel_destination"
#gem 'spree_travel_program',      :git => "#{SPREE_TRAVEL_PATH}/spree_travel_destination"
#gem 'spree_travel_route',        :git => "#{SPREE_TRAVEL_PATH}/spree_travel_destination"
#gem 'spree_travel_tour',         :git => "#{SPREE_TRAVEL_PATH}/spree_travel_destination"
#gem 'spree_travel_transfer',     :git => "#{SPREE_TRAVEL_PATH}/spree_travel_destination"
